    ...
    <div className='bg-[#1e213a] h-screen flex flex-col justify-around items-center w-full  md:w-[50%]'>
      ...
      {response !== null &&
        <>
          ...
          <p className=' text-[40px] font-bold w-full text-center  ' >{response.weather[0].description}</p>
          <span className='flex w-full justify-center   my-[10px] text-lg' >
            <p className='' >Today ,    {dateTime}</p>
